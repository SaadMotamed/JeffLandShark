...
static const FName NAME_UAdvancedFriendsGameInstance_OnPlayerLoginChanged = FName(TEXT("OnPlayerLoginChanged"));
void UAdvancedFriendsGameInstance::OnPlayerLoginChanged(int32 PlayerNum)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UAdvancedFriendsGameInstance_OnPlayerLoginChanged);
...
static const FName NAME_UAdvancedFriendsGameInstance_OnPlayerLoginStatusChanged = FName(TEXT("OnPlayerLoginStatusChanged"));
void UAdvancedFriendsGameInstance::OnPlayerLoginStatusChanged(int32 PlayerNum, EBPLoginStatus PreviousStatus, EBPLoginStatus NewStatus, FBPUniqueNetId NewPlayerUniqueNetID)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UAdvancedFriendsGameInstance_OnPlayerLoginStatusChanged);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UAdvancedFriendsGameInstance_OnPlayerTalkingStateChanged = FName(TEXT("OnPlayerTalkingStateChanged"));
void UAdvancedFriendsGameInstance::OnPlayerTalkingStateChanged(FBPUniqueNetId PlayerId, bool bIsTalking)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UAdvancedFriendsGameInstance_OnPlayerTalkingStateChanged);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UAdvancedFriendsGameInstance_OnSessionInviteAccepted = FName(TEXT("OnSessionInviteAccepted"));
void UAdvancedFriendsGameInstance::OnSessionInviteAccepted(int32 LocalPlayerNum, FBPUniqueNetId PersonInvited, FBlueprintSessionResult const& SessionToJoin)
{
	...
	UFunction* Func = FindFunctionChecked(NAME_UAdvancedFriendsGameInstance_OnSessionInviteAccepted);
	ProcessEvent(Func,&Parms);
}
...
static const FName NAME_UAdvancedFriendsGameInstance_OnSessionInviteReceived = FName(TEXT("OnSessionInviteReceived"));
void UAdvancedFriendsGameInstance::OnSessionInviteReceived(int32 LocalPlayerNum, FBPUniqueNetId PersonInviting, const FString& AppId, FBlueprintSessionResult const& SessionToJoin)
{
	...
	Parms.AppId=AppId;
	Parms.SessionToJoin=SessionToJoin;
	UFunction* Func = FindFunctionChecked(NAME_UAdvancedFriendsGameInstance_OnSessionInviteReceived);
	ProcessEvent(Func,&Parms);
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_yazan_OneDrive_Desktop_JeffShark_JeffLandShark_BestGameEver_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsGameInstance_h_Statics
{
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_yazan_OneDrive_Desktop_JeffShark_JeffLandShark_BestGameEver_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsGameInstance_h_3559413466(TEXT("/Script/AdvancedSessions"),
	Z_CompiledInDeferFile_FID_Users_yazan_OneDrive_Desktop_JeffShark_JeffLandShark_BestGameEver_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_yazan_OneDrive_Desktop_JeffShark_JeffLandShark_BestGameEver_Plugins_AdvancedSessions_Source_AdvancedSessions_Classes_AdvancedFriendsGameInstance_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
